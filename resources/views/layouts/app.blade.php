...
<head>
  ...
  {{-- <link rel="icon" type="image/png" href="{{ asset('/assets/images/e-learning.svg') }}"> --}}
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" style="background-color: white;">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#">
        ...
        <span class="ms-2 font-weight-bold text-primary" style="font-size: 18px;">Karyanwanku</span>
      </a>
    </div>
